    ...
    <template slot="style">
      <el-form label-width="80px" size="mini" label-position="left">
        <el-collapse v-model="activeNames">
          ...
          <el-form-item label="日历高度">
            <el-input-number size="mini" v-model="optionStyle.calendar[0].cellSize[1]" controls-position="right" :min="0" :max="128"></el-input-number>
          </el-form-item>
          <el-form-item label="日历宽度">
            <el-input-number size="mini" v-model="optionStyle.calendar[0].cellSize[0]" controls-position="right" :min="0" :max="128"></el-input-number>
          </el-form-item>
          </el-collapse-item>
