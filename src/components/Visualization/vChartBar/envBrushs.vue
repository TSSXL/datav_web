  ...
  export default {
    ...
    methods: {
      getChartOption(option) {
        ...
        chartOption.yAxis["splitLine"]["show"]=false;
        chartOption.yAxis["splitArea"]["show"]=false;
        ...
        chartOption.legend.data = [chartOption.series[0].name, chartOption.series[1].name];
        ...
        chartOption.series[1].data = option.data.static_data.map(item => (0 - item.val2));
