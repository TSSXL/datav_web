  ...
  <div class="app-container item">
    ...
    <el-form ref="form" label-width="120px" size="mini">
      ...
      <el-form-item label="所属模块">
        <el-select v-if="options && options.length > 0" v-model="model.refModule" data-vv-as="所属模块" name="module" v-validate="'required'"
...
<script>
  import baseEdit from '@/views/base/server/baseEdit'
