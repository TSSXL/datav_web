...
<script>
  import {getItem, editItem} from "@/views/console/app/api";
        ...
        app:
          {
            ...
            desc: '',
            publishPolicy: {policy: ['全公开'], inherit: false},
            apikey: {key: '', inherit: false},
            attributes: []
          },
    ...
    methods: {
      ...
      onSubmit() {
        this.$validator.validateAll().then(result => {
          ...
          if (result) {
            editItem(this.id, this.app).then(response => {
              this.$notify({
                title: '成功',
                message: '修改成功',
                type: 'success',
