  ...
  <div class="app-container item">
    ...
    <el-form ref="form" label-width="120px" size="mini">
        ...
        <el-form-item label="cron表达式">
            ...
            <el-input 
              v-model="crontrigger.cronExpressions" 
              type="text" :rows="1"
              :autosize="true">
            </el-input>
            
          <error-tip :errs="errors" name="cronExpressions"></error-tip>
        </el-form-item>        
...
export default {
  ...
  methods: {
      ...
      handleTagtagClose(tag) {
        this.crontrigger.tag.splice(this.crontrigger.tag.indexOf(tag), 1);
      },
      showTagtagInput() {
      ...
      handleTagtagInputConfirm() {
        ...
        if (inputValue) {
          this.crontrigger.tag.push(inputValue);
        }
    ...
    fetchData() {
      getItem(this.id).then(response => {
        this.crontrigger = response.data;
      });
    },
    ...
    onSubmit() {
      ...
      if (this.errors.any()) {
        ...
        if (result) {         
          editItem(this.id, this.crontrigger).then(response => {
              this.$notify({
                title: '成功',
                message: '修改成功',
                type: 'success',
