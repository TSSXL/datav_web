        ...
        <el-form ref="form" label-width="120px" size="mini">
            ...
            <el-form-item label="机构名称">
                ...
                <el-input
                        ...
                        type="text" :rows="2"
                        :autosize="false"
                        name="name" data-vv-as="机构名称" v-validate="'required'" style="width:250px;">
                </el-input>
          ...
          <el-form-item label="行政机构分类">

            <el-select
              v-model="userNode.civilServiceType"
              :multiple="false"
              :clearable="false"
              :filterable="false"
              :allow-create="false"
              name="civilServiceType" data-vv-as="行政机构分类" style="width:250px;">
              <el-option
                v-for="item in civilServiceTypeOptions"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
            ...
            <error-tip :errs="errors" name="civilServiceType"></error-tip>
          </el-form-item>

          <el-form-item label="行政机构级别">

            <el-select
              v-model="userNode.civilServiceLevel"
              :multiple="false"
              :clearable="false"
              :filterable="false"
              :allow-create="false"
              name="civilServiceLevel" data-vv-as="行政机构级别" style="width:250px;">
              <el-option
                v-for="item in civilServiceLevelOptions"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
            ...
            <error-tip :errs="errors" name="civilServiceLevel"></error-tip>
          </el-form-item>
