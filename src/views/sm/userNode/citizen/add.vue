        ...
        <el-form ref="form" label-width="120px" size="mini">
            ...
            <el-form-item label="姓名">
                ...
                <el-input
                        ...
                        type="text" :rows="2"
                        :autosize="false"
                        name="name" data-vv-as="姓名" v-validate="'required'" style="width:250px;">
                </el-input>
            ...
            <el-form-item label="身份证号">
              ...
              <el-input
                v-model="userNode.citizenIdNo"
                type="text" :rows="2"
                :autosize="false"
                name="citizenIdNo" data-vv-as="身份证号" v-validate="'required'" style="width:250px;">
              </el-input>

              <error-tip :errs="errors" name="citizenIdNo"></error-tip>
            </el-form-item>
          ...
          <el-form-item label="手机">
            ...
            <el-input
              ...
              type="text" :rows="2"
              :autosize="false"
              name="telephone" data-vv-as="手机" v-validate="'required'" style="width:250px;">
            </el-input>
          ...
          <el-form-item label="区域">
            ...
            <el-form-item label="是否常驻">
                ...
                <el-radio-group
                        v-if="isResidentOptions.length>0"
                        v-model="userNode.isResident">
                    <el-radio v-for="item in isResidentOptions"
                              :key="item.value" :label="item.value"
                              name="isResident" data-vv-as="是否常驻"
                              >{{item.label}}
                    </el-radio>
                </el-radio-group>


                <error-tip :errs="errors" name="isResident"></error-tip>
            </el-form-item>
