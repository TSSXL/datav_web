    ...
    <el-row :gutter="30">
      ...
      <el-col :span="12" style="height: calc(100vh - 124px); overflow-y: auto">
        ...
        <span v-if="actionType=='add'">
          <span style="font-size: 14px;"> 新建路由</span>
        </span>
        <span v-if="actionType=='edit'">
          <span style="font-size: 14px;"> 编辑路由</span>
        </span>
        ...
        <el-form ref="form" label-width="120px" size="mini" v-if="actionType=='add' || actionType=='edit'">
          ...
          <el-form-item label="Label">
            <el-input v-model="newNode.label" type="text">
            </el-input>
          </el-form-item>
          <el-form-item label="Value">
            <el-input v-model="newNode.value" type="text">
            </el-input>
          </el-form-item>
...
<script>
  import { getTree, addItem, editItem, removeItem, editSort } from "./api"
  ...
  export default {
    ...
    data() {
      return {
        ...
        loading: false,
        listLoading: false,
        nodeObj: { label: '', value: '', icon: '', parentId: '', desc: '', attribute: {}, sort: 0, group: 'default' },
        viewProps: ['_id', 'parentId', 'label', 'value', 'icon', 'attribute', 'desc'],
        newNode: {},
        currentNode: {},
        defaultProps: {
          children: 'children',
