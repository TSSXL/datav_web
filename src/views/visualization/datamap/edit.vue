  ...
  <div class="app-container item">
    ...
    <el-form ref="form" label-width="120px" size="mini">
      ...
      <el-form-item label="SQL">
        ...
        <br>
        var o = {}; //原始对象
        <cm-json-editor v-if="datamap.execSqlResult" v-model="datamap.execSqlResult"
      ...
      <el-form-item label="转换脚本">
        ...
        <cm-json-editor v-if="datamap.transResult" v-model="datamap.transResult"
                        style="font-size: 10px;"></cm-json-editor>
      </el-form-item>
...
<script>
  import {getItem, editItem} from "@/views/visualization/datamap/api";
  ...
  export default {
    ...
    methods: {fetchCollectTasks() {
        ...
        var objQuery = [{taskType: 'collection'}]
      ...
      fetchSubscribeTasks() {
        ...
        var objQuery = [{taskType: 'subscription'}]
      ...
      onSubmit() {
        this.$validator.validateAll().then(result => {
          ...
          if (result) {
            editItem(this.id, this.datamap).then(response => {
              this.$notify({
                title: '成功',
                message: '修改成功',
                type: 'success',
