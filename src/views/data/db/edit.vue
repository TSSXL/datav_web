          ...
          <el-form-item label="描述">
            ...
            <el-form-item label="数据库类型">
                ...
                <el-select
                        ...
                        :filterable="false"
                        :allow-create="false"
                        name="type" data-vv-as="数据库类型" v-validate="'required'">
                    <el-option
            ...
            <el-form-item label="数据库端口">
                ...
                <error-tip :errs="errors" name="dbPort"></error-tip>
            </el-form-item>
            ...
            <el-form-item label="字符集">
                ...
                <error-tip :errs="errors" name="characterSet"></error-tip>
            </el-form-item>
...
<script>
    import {
        getItem,
        editItem } from  "@/views/data/db/api";
      ...
      methods: {
        ...
        onSubmit() {
          this.$validator.validateAll().then(result => {
            ...
            if (result) {
              editItem(this.id, this.db).then(response => {
                this.$notify({
                  title: '成功',
                  message: '修改成功',
                  type: 'success',
